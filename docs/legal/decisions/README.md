...
| EPG-16 | AML caps default 0 (unlimited); per-licensee via C8 token; 0 = unlimited guard in `velocity.py` | ✅ Implemented | 2026-03-18 | CIPHER | [`EPG-16-18_aml_caps_human_review.md`](EPG-16-18_aml_caps_human_review.md) |
